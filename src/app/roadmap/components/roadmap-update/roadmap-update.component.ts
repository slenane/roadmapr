...
export class RoadmapUpdateComponent implements OnInit {
  ...
  public roadmapForm = new FormGroup({ type: new FormControl('', Validators.required) });
  ...
  ngOnInit(): void {
    this.roadmapForm.controls.type.valueChanges.subscribe((type: any) => this.selectedType = type);
  }

  getFormData(): any {
    switch(this.selectedType) {
      case 'book': return this.book.getData();
      // case 'course': return this.course.getData();
      // case 'degree': return this.degree.getData();
