...
@Component({
  selector: "app-roadmap-skill-distribution",
  templateUrl: "./roadmap-skill-distribution.component.html",
  styleUrls: ["./roadmap-skill-distribution.component.scss"],
})
export class RoadmapSkillDistributionComponent implements OnInit {
