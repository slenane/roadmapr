...
@Component({
  selector: "app-roadmap-stack-radar",
  templateUrl: "./roadmap-stack-radar.component.html",
  styleUrls: ["./roadmap-stack-radar.component.scss"],
})
export class RoadmapStackRadarComponent implements OnInit, OnChanges {
  public stack: any = {};
  public chart: Chart;
