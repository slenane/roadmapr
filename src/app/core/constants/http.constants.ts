const AUTH_LOGIN = "/api/auth/login",
  ...
  AUTH_REGISTER_RESEND_EMAIL = "/api/auth/register-resend-email",
  ...
  ROADMAP_GET = "/api/roadmap/",
  ROADMAP_UPDATE = "/api/roadmap/",
  ...
  EXPERIENCE_GET = "/api/experience/",
  EXPERIENCE_CREATE = "/api/experience/",
  EXPERIENCE_UPDATE = "/api/experience/edit/",
  EXPERIENCE_BULK_UPDATE = "/api/experience/bulk-edit/",
  EXPERIENCE_REMOVE = "/api/experience/remove/",
  ...
  REMOVE_GITHUB = "/api/settings/remove-github/",
